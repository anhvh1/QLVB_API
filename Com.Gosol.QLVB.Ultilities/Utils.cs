...
namespace Com.Gosol.QLVB.Ultilities
{
    ...
    public static class Utils
    {
        ...
        public static bool? ConvertToNullableBoolean(object value, bool? defaultValue)
        {
            try
            {
                return Convert.ToBoolean(value.ToString());
        ...
        public static DateTime? ConvertNgaySinh(string NgaySinh)
        {
            var nam = "";
            var thang = "";
            var ngay = "";
                ...
                if (nam == "")
                {
                    ...
                    if (arr != null && arr.Length == 3)
                    {
                        ...
                        if (arr[2] != null)
                        {
                            ...
                            {
                                var nam_tmp = arr[2].Trim().Split(" ");
                                if (nam_tmp != null && nam_tmp.Length > 0) { nam = nam_tmp[0]; }
                            }
                        }
                        //thang
                        if (arr[1] != null)
            ...
            return ConvertToNullableDateTime(ngay + "/" + thang + "/" + nam, null);
        }

        public static int ConvertNgaySinhStrToInt(string NgaySinhStr)
        {
            int NgaySinhInt = 0;
            try
            {
